...
export const SprintNotification: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-sm">
      <div className="bg-blue-600 dark:bg-blue-700 text-white rounded-lg shadow-lg border border-blue-700 dark:border-blue-600 p-4">
        <div className="flex items-start space-x-3">
          <Calendar className="h-5 w-5 text-blue-200 dark:text-blue-300 mt-0.5 flex-shrink-0" />
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              onClick={handleSwitchToClosed}
                className="flex items-center space-x-2 px-3 py-1.5 bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 rounded-md hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors text-sm font-medium"
              >
              ...
              <button
                ...
                className="p-1.5 text-blue-200 dark:text-blue-300 hover:text-white hover:bg-blue-700 dark:hover:bg-blue-600 rounded-md transition-colors"
