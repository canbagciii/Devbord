    ...
    <>
      ...
      >
        ...
        <div className="flex-1 min-w-0 text-left">
          ...
          <div className="flex items-center space-x-1">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">{getRoleText(user.role)}</p>
          </div>
        </div>
      </button>
      ...
      {showDropdown && (
        <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Erişim Yetkileriniz</h4>
            <div className="space-y-2">
              {hasRole('admin') ? (
                <div className="text-xs text-green-600 dark:text-green-300 bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded">
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-1">
                    {accessibleProjects.map(project => (
                      <span key={project} className="text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 px-2 py-1 rounded">
                        {project}
                      </span>
                    ))}
                  </div>
                  {user.role === 'developer' && (
                    <div className="text-xs text-yellow-600 dark:text-yellow-300 bg-yellow-50 dark:bg-yellow-900/30 px-2 py-1 rounded">
                      ⚠️ Sadece kendi verilerinizi görüntüleyebilirsiniz
                    </div>
                  )}
                  {user.role === 'analyst' && (
                    <div className="text-xs text-blue-600 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded">
          ...
          <div className="p-2">
            <button
              ...
              className="w-full flex items-center space-x-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors mb-1"
            >
            ...
            <button
              ...
              className="w-full flex items-center space-x-2 px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors"
            >
      ...
      {hasRole('admin') && showJiraFilters && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-5xl mx-4 max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2">
                <Filter className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Jira Yönetimi</h3>
              </div>
              <button
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4">
            <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Şifre Değiştir</h3>
              </div>
              <button
            ...
            <form onSubmit={handlePasswordChange} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
