  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!jiraRes.ok) {
        ...
        setValidationError(
          errorMap[status] || {
            title: `Bağlantı hatası (HTTP ${status})`,
      ...
      setValidationError({
        ...
        description: 'Sunucuya bağlanırken bir ağ hatası oluştu.',
        hint: 'Base URL\'nin doğru olduğundan ve internet bağlantınızın çalıştığından emin olun.',
      });
      setLoading(false);
      setLoadingStep('idle');
      return;
      ...
      <div className="bg-white rounded-3xl w-full max-w-[520px] shadow-2xl max-h-[92vh] overflow-y-auto relative animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="p-10">
            ...
            <div className="mb-6 rounded-xl border border-red-200 bg-red-50 overflow-hidden">
              ...
              <div className="px-4 py-3.5 space-y-2">
                ...
                {validationError.hintLink && (
                  <a
                    href={validationError.hintLink.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-[0.8rem] font-semibold text-blue-600 hover:underline mt-0.5"
                  >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3.5">
                <div>
                  ...
                  <input
                    type="email" name="userEmail" value={formData.userEmail} onChange={handleChange} required
                    className="w-full px-3.5 py-2.5 border-[1.5px] border-gray-300 rounded-lg text-sm text-gray-900 bg-gray-50 focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-600/10 outline-none transition-all"
            ...
            {/* Jira Entegrasyonu — hata varsa kırmızı başlık + kırmızı input border */}
            <div className="mb-6">
              ...
              <div className="space-y-3.5">
                <div>
                  ...
                  <input
                    type="email" name="jiraEmail" value={formData.jiraEmail} onChange={handleChange} required
                    className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-lg text-sm text-gray-900 bg-gray-50 focus:bg-white focus:ring-4 outline-none transition-all ${
                      validationError ? 'border-red-300 focus:border-red-400 focus:ring-red-500/10' : 'border-gray-300 focus:border-blue-600 focus:ring-blue-600/10'
                    }`}
                ...
                <div>
                  ...
                  <input
                    type="password" name="jiraApiToken" value={formData.jiraApiToken} onChange={handleChange} required
                    className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-lg text-sm text-gray-900 bg-gray-50 focus:bg-white focus:ring-4 outline-none transition-all ${
                      validationError ? 'border-red-300 focus:border-red-400 focus:ring-red-500/10' : 'border-gray-300 focus:border-blue-600 focus:ring-blue-600/10'
                    }`}
                    placeholder="••••••••••••••••••••"
                ...
                <div>
                  ...
                  <input
                    type="url" name="jiraBaseUrl" value={formData.jiraBaseUrl} onChange={handleChange} required
                    className={`w-full px-3.5 py-2.5 border-[1.5px] rounded-lg text-sm text-gray-900 bg-gray-50 focus:bg-white focus:ring-4 outline-none transition-all ${
                      validationError ? 'border-red-300 focus:border-red-400 focus:ring-red-500/10' : 'border-gray-300 focus:border-blue-600 focus:ring-blue-600/10'
                    }`}
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3.5">
                <div>
                  ...
                  <input
                    type="password" name="kolayikApiToken" value={formData.kolayikApiToken} onChange={handleChange}
                    className="w-full px-3.5 py-2.5 border-[1.5px] border-gray-300 rounded-lg text-sm text-gray-900 bg-gray-50 focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-600/10 outline-none transition-all"
                    placeholder="••••••••••••••••••••"
                  />
                ...
                <div>
                  ...
                  <input
                    type="url" name="kolayikBaseUrl" value={formData.kolayikBaseUrl} onChange={handleChange}
                    className="w-full px-3.5 py-2.5 border-[1.5px] border-gray-300 rounded-lg text-sm text-gray-900 bg-gray-50 focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-600/10 outline-none transition-all"
