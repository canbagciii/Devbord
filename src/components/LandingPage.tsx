        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: <LinkIcon className="w-6 h-6 text-blue-600" />, title: 'Jira Entegrasyonu', desc: "Mevcut Jira projelerinizle tam entegrasyon. Ticket'lar, board'lar, sprint'ler — hepsi Scrumlytics'ta, hiçbir veri girilmesine gerek yok." },
