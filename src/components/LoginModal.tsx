...
export const LoginModal: React.FC<LoginModalProps> = ({ onClose, onSwitchToRegister }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-[520px] shadow-2xl p-10 relative animate-in fade-in zoom-in-95 duration-300">
        <button
          onClick={onClose}
        ...
        <div className="mb-7">
          <h2 className="text-2xl font-extrabold text-gray-900 dark:text-gray-100 mb-1.5">Tekrar hoş geldiniz 👋</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400">Devbord hesabınıza giriş yapın</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-3.5 mb-6">
            <div>
              <label className="block text-[0.82rem] font-semibold text-gray-900 dark:text-gray-100 mb-1.5">E-posta</label>
              <input
                type="email"
                name="email"
                ...
                required
                className="w-full px-3.5 py-2.5 border-[1.5px] border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 focus:border-blue-600 focus:bg-white dark:focus:bg-gray-700 focus:ring-4 focus:ring-blue-600/10 outline-none transition-all"
                placeholder="ornek@sirket.com"
              />
            </div>
            <div>
              <label className="block text-[0.82rem] font-semibold text-gray-900 dark:text-gray-100 mb-1.5">Şifre</label>
              <input
                type="password"
                name="password"
          ...
          <div className="text-center mt-4 text-[0.83rem] text-gray-600 dark:text-gray-400">
            Hesabınız yok mu?{' '}
            <button
              type="button"
