  ...
  return (
    <div className="fixed bottom-4 left-52 z-40 w-48">
      ...
      {connectionStatus && !connectionStatus.success && (
        <div className="absolute bottom-full left-0 mb-2 w-80 bg-white border border-red-200 rounded-lg shadow-lg p-3 z-[60]">
          <p className="text-sm text-red-800">{connectionStatus.message}</p>
