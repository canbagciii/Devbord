/*
  ...
  ## Indexes Added
  1. `idx_chatbot_categories_created_by` - for chatbot_categories.created_by
  2. `idx_chatbot_conversations_category_id` - for chatbot_conversations.category_id
  3. `idx_chatbot_documents_uploaded_by` - for chatbot_documents.uploaded_by
  4. `idx_selected_developers_created_by` - for selected_developers.created_by
  5. `idx_selected_projects_created_by` - for selected_projects.created_by
*/
