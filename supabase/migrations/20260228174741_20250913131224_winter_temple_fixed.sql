...
-- Create developer_capacities table if it doesn't exist
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'developer_capacities' AND policyname = 'Public can view capacities'
  ) THEN
    CREATE POLICY "Public can view capacities"
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'developer_capacities' AND policyname = 'Public can insert capacities'
  ) THEN
    CREATE POLICY "Public can insert capacities"
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'developer_capacities' AND policyname = 'Public can update capacities'
  ) THEN
    CREATE POLICY "Public can update capacities"
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'developer_capacities' AND policyname = 'Public can delete capacities'
  ) THEN
    CREATE POLICY "Public can delete capacities"
